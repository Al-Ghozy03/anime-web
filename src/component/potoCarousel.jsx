  ...
  return (
    <React.Fragment>
      <div>
        <div
          style={{
            backgroundImage: `url("https://images7.alphacoders.com/115/thumb-1920-1155001.jpg")`,
          }}
          ...
          <div className="tinggi bg-gradient-to-r from-black py-16 px-11 rounded-3xl">
            ...
            <div className="grid grid-cols-2">
              <p className="text-white text-xl">
                Saat menonton berita, Takemichi Hanagaki terkejut mengetahui
                mantan pacarnya, Hinata Tachibana meninggal dunia. Hinata
                dibunuh oleh kelompok yang dikenal sebagai Geng Manji Tokyo.
                Takemichi yang saat ini berada di titik terendah hidupnya
                tiba-tiba ia melompati waktu ke masa dua belas tahun, ketika
                dirinya masih menjalin hubungan dengan Hinata. Menyadari dia
                memiliki kesempatan untuk menyelamatkan Hinata, ia memutuskan
                untuk menyusup ke Geng Manji Tokyo dan mengubah takdir.
              </p>
            </div>
