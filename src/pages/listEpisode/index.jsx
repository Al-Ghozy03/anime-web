          ...
          <div className="flex justify-between mx-12 font-semibold text-2xl ">
            ...
            <div>
              <h1 className="mb-2">
                Jumlah Episode :{" "}
                <span className="capitalize font-normal">
                  {detailAnime[params.id].jumlahEpisode}
                </span>
              </h1>
              <h1>
                Status :{" "}
