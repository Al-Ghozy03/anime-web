...
export default function ListEpisode() {
  ...
  let { id } = useParams();
  let episode = detailAnime[params.id].episode
  return (
    <React.Fragment>
      <div className="">
        <Header></Header>
        <div className="px-12 h-screen py-8">
          ...
          <div
            ...
            className=" bg-cover bg-no-repeat bg-red-400 h-7/10 rounded-2xl  mx-10"
          ></div>
          <div className="flex justify-between px-12 py-9 font-semibold text-2xl ">
            <div>
              <h1 className="mb-2">
                Judul : {''}  
          ...
          <div className="px-10 pt-8">
            ...
            <p className="text-xl px-8 mt-4">{detailAnime[params.id].sinopsis}</p>
          </div>
